                    ...
                    {this.props.loggedIn ==="true"?
                       <div className="after-login">
                        <IconButton style={{padding :'0'}} onClick={this.handleClick}>
                            <img src={this.state.photo} alt="" style={{width: 40, height: 40, borderRadius: 40/2}} />
                        </IconButton>
                        <Menu className="simple-menu" elevation={0} getContentAnchorEl={null} anchorEl={this.state.anchorEl} anchorOrigin={{
                                                      vertical: 'bottom',
                                                      horizontal: 'center',
                                                    }} transformOrigin={{
                                                      vertical: 'top',
